...
namespace Fawatir
{
    public partial class bills_details : System.Web.UI.Page
    {
        ...
        public string getDiv()
        {
            ...
            if (Request["water_invoice_id"] != null)
            {
                ...
                string sql = "select * from bills Inner Join waterservices on s_id=w_Id Inner Join Users on usere=email where b_Id = @id and type=@type and usere=@u";
                ...
                sqlCommand.Parameters.AddWithValue("@u", Session["UserEmailID"]);
            ...
            else if (Request["internet_invoice_id"] != null)
            {
                ...
                string sql = "select * from bills Inner Join InternetServices on s_id=i_Id Inner Join Users on usere=email where b_Id = @id and type=@type and usere=@u";
                String cnxString = System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
                SqlConnection sqlCnx = new SqlConnection(cnxString);
                sqlCnx.Open();
                SqlCommand sqlCommand = new SqlCommand(sql, sqlCnx);
            ...
            else if (Request["local_invoice_id"] != null)
            {
                ...
                string sql = "select * from bills Inner Join LocalServices on s_id=l_Id Inner Join Users on usere=email where b_Id = @id and type=@type and usere=@u";
                String cnxString = System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
                SqlConnection sqlCnx = new SqlConnection(cnxString);
                sqlCnx.Open();
                SqlCommand sqlCommand = new SqlCommand(sql, sqlCnx);
            ...
            if (Request["electricity_invoice_id"] != null)
            {
                ...
                string sql1 = "select * from bills Inner Join electricityservices on s_id=e_Id Inner Join Users on usere=email where b_Id = @id and type=@type and usere=@u";
                ...
                sqlCommand1.Parameters.AddWithValue("@u", Session["UserEmailID"]);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string strFileName = Session["payedtype"]+" Invoice/month: "+Session["payeddate"] + ".doc";
