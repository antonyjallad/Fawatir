<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bill.aspx.cs" Inherits="Fawatir.bill" %>
            ...
            <form id="form1" runat="server">
                <div class="form-wrapper">
                  <div class="profile_links">
                      ...
                      <asp:Button ID="Button2" runat="server" OnClick="Button1_Click" class="links" Text="Log Out" />
                  </div>
                </div>
            </form>           
        </div>
    ...
    <script type="text/javascript" src="assets/js/main.js"></script>
     ...
     <script>
       function Details1(id)
        {
            window.location.href = "bills_details.aspx?internet_invoice_id=" + id;
         }
         function Details2(id) {
             window.location.href = "bills_details.aspx?water_invoice_id=" + id;
         } function Details3(id) {
             window.location.href = "bills_details.aspx?electricity_invoice_id=" + id;
         } function Details4(id) {
             window.location.href = "bills_details.aspx?local_invoice_id=" + id;
         }
