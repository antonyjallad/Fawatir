<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AvailableServices.aspx.cs" Inherits="Fawatir.AvailableServices" %>
   ...
   <div class="data_table">
    ...
    <script type="text/javascript" src="assets/js/main.js"></script>
     ...
     <script>
       function Details(id)
        {
            window.location.href = "Details.aspx?electricity_id=" + id;
         }
         function Details1(id) {
             window.location.href = "Details.aspx?water_id=" + id;
         } function Details2(id) {
             window.location.href = "Details.aspx?internet_id=" + id;
         } function Details3(id) {
             window.location.href = "Details.aspx?local_id=" + id;
         } 
